...
from src.US_Visa_Approval.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from src.US_Visa_Approval.entity.config_entity import ModelTrainerConfig
from src.US_Visa_Approval.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetrixArtifact
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            metric_artifact = ClassificationMetrixArtifact(f1_score=f1, precision_score=precision, recall_score=recall)
